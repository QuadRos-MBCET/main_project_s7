...
VALID_CLASSES = {"SAFE_FOR_ALL", "SAFE_14_PLUS", "SAFE_18_PLUS", "UNSAFE_FOR_ALL"}

class TestSafeAdModerationPipeline(unittest.TestCase):
    """
    Comprehensive test suite verifying the 12 required SafeAd AI moderation scenarios.
    """
    ...
    def _assert_valid_result_schema(self, res: dict):
        ...
        self.assertIn(res["publication_action"], {"APPROVE", "AGE_RESTRICT", "REJECT"})
    ...
    def test_8_video_with_ocr_text(self):
        ...
        if os.path.exists(self.casino_vid):
            ...
            self._assert_valid_result_schema(res)
            self.assertIn(res["classification"], {"SAFE_18_PLUS", "SAFE_14_PLUS", "UNSAFE_FOR_ALL"})
