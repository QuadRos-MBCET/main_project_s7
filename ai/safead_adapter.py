class SafeAdModelService:
    ...
    def adapt_prediction(
        ...
        """
        Adapts raw multimodal model predictions into the SafeAd standardized 4-Class schema:
        ...
        # Check violations list or Phase 1 risk flags
        ...
        if fused_score > 75.0 or visual_risk > 85.0 or has_violence or has_child_risk or has_misleading:
        ...
        # 2. AGE_18_PLUS: Gambling, Adult Content, Alcohol/Tobacco, Drugs, or Moderate Risk (> 35%)
        elif has_adult or has_gambling or has_substances or visual_risk > 50.0 or fused_score > 35.0:
        ...
        return {
            ...
            "risk_score": round(fused_score, 2) if risk_score_available else None,
